public static class DialingCodes
{
    ...
    public static string FindLongestCountryName(Dictionary<int, string> existingDictionary) => existingDictionary.Values.OrderByDescending(v => v.Length).FirstOrDefault("");
}