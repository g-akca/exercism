public class SecurityPassMaker
{
    ...
    {
        if (support is Staff) {
            if (support is Security && support is not SecurityJunior && support is not SecurityIntern && support is not PoliceLiaison) return $"{support.Title} Priority Personnel";
